PROGRAM stats_1
    ...
    DO
        ! Read in next value
        WRITE (*,*) 'Enter positive number to add to sample or a negative number to stop adding values: '
        READ (*,*) x
    ...
    ELSE ! There is enough information, so calculate the mean and standard deviation
        x_bar = sum_x / real(n)
